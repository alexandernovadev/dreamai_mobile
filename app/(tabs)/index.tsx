      ...
      <View style={[s.safe, { paddingTop: insets.top }]}>
        <View style={s.header}>
          ...
          <View style={s.subtitleRow}>
            ...
            <Text style={s.subtitle}>Tu diario de sueños</Text>
          </View>
        </View>
        ...
        <View style={s.emptyCenter}>
          ...
          <Text style={s.emptyTitle}>Bienvenido a Dreamia</Text>
          <Text style={s.emptyDesc}>
            Aquí verás un resumen de tu actividad onírica, patrones y estadísticas.
          </Text>
